            ...
            <div className="hidden sm:flex items-center space-x-3">
              ...
              <div className="relative">
                <button
                  ...
                  className="relative p-2 text-slate-400 hover:text-white transition-colors duration-200 rounded-lg hover:bg-slate-800/50"
                >
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 p-2 rounded-lg hover:bg-slate-800/50 transition-colors duration-200 group"
                >
